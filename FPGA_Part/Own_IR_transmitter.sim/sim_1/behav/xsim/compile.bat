...
REM
REM Generated by Vivado on Thu Aug 07 15:14:16 +0800 2025
...
echo "xvlog --incr --relax -prj IR_transmitter_tb_vlog.prj"
call xvlog  --incr --relax -prj IR_transmitter_tb_vlog.prj -log xvlog.log
