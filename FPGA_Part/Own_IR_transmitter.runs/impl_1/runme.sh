...
HD_PWD='C:/Users/azati/Own_IR_transmitter/Own_IR_transmitter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IR_transmission.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IR_transmission.tcl -notrace
