...
HD_PWD='C:/Users/azati/Own_IR_transmitter/Own_IR_transmitter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IR_transmission.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IR_transmission.tcl
