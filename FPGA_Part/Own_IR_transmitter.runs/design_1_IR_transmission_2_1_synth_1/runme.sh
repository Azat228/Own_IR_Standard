...
HD_PWD='C:/Users/azati/Own_IR_transmitter/Own_IR_transmitter.runs/design_1_IR_transmission_2_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_IR_transmission_2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_IR_transmission_2_1.tcl
