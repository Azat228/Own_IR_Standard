...
EAStep vivado -log design_1_IR_transmission_10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_IR_transmission_10_0.tcl
