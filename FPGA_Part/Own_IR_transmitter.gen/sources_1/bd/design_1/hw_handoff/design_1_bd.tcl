...
# module references:
# IR_transmission, IR_transmission, IR_transmission, IR_transmission, IR_transmission, IR_transmission, IR_transmission, IR_transmission, IR_transmission, IR_transmission, transmitt_parallel
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk_ask_0 [ create_bd_port -dir I clk_ask_0 ]
  set clk_ask_1 [ create_bd_port -dir I clk_ask_1 ]
  set ir_parallel_0 [ create_bd_port -dir O -from 9 -to 0 ir_parallel_0 ]

  # Create instance: IR_transmission_0, and set properties
  set block_name IR_transmission
  set block_cell_name IR_transmission_0
  if { [catch {set IR_transmission_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $IR_transmission_0 eq "" } {
  ...
  set block_name IR_transmission
  set block_cell_name IR_transmission_1
  if { [catch {set IR_transmission_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $IR_transmission_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: IR_transmission_2, and set properties
  set block_name IR_transmission
  set block_cell_name IR_transmission_2
  if { [catch {set IR_transmission_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
  ...
  # Create instance: transmitt_parallel_0, and set properties
  set block_name transmitt_parallel
  set block_cell_name transmitt_parallel_0
  if { [catch {set transmitt_parallel_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $transmitt_parallel_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net IR_transmission_0_ir_out [get_bd_pins IR_transmission_0/ir_out] [get_bd_pins transmitt_parallel_0/ir_send_0]
  connect_bd_net -net IR_transmission_1_ir_out [get_bd_pins IR_transmission_1/ir_out] [get_bd_pins transmitt_parallel_0/ir_send_1]
  connect_bd_net -net IR_transmission_2_ir_out [get_bd_pins IR_transmission_2/ir_out] [get_bd_pins transmitt_parallel_0/ir_send_2]
  connect_bd_net -net IR_transmission_3_ir_out [get_bd_pins IR_transmission_3/ir_out] [get_bd_pins transmitt_parallel_0/ir_send_3]
  connect_bd_net -net IR_transmission_4_ir_out [get_bd_pins IR_transmission_4/ir_out] [get_bd_pins transmitt_parallel_0/ir_send_4]
  connect_bd_net -net IR_transmission_5_ir_out [get_bd_pins IR_transmission_5/ir_out] [get_bd_pins transmitt_parallel_0/ir_send_5]
  connect_bd_net -net IR_transmission_6_ir_out [get_bd_pins IR_transmission_6/ir_out] [get_bd_pins transmitt_parallel_0/ir_send_6]
  connect_bd_net -net IR_transmission_7_ir_out [get_bd_pins IR_transmission_7/ir_out] [get_bd_pins transmitt_parallel_0/ir_send_7]
  connect_bd_net -net IR_transmission_8_ir_out [get_bd_pins IR_transmission_8/ir_out] [get_bd_pins transmitt_parallel_0/ir_send_8]
  connect_bd_net -net IR_transmission_9_ir_out [get_bd_pins IR_transmission_9/ir_out] [get_bd_pins transmitt_parallel_0/ir_send_9]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins IR_transmission_0/code] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins IR_transmission_0/addr] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net axi_gpio_10_gpio2_io_o [get_bd_pins IR_transmission_9/code] [get_bd_pins axi_gpio_10/gpio2_io_o]
  connect_bd_net -net axi_gpio_10_gpio_io_o [get_bd_pins IR_transmission_9/addr] [get_bd_pins axi_gpio_10/gpio_io_o]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins IR_transmission_0/send] [get_bd_pins IR_transmission_1/send] [get_bd_pins IR_transmission_2/send] [get_bd_pins IR_transmission_3/send] [get_bd_pins IR_transmission_4/send] [get_bd_pins IR_transmission_5/send] [get_bd_pins IR_transmission_6/send] [get_bd_pins IR_transmission_7/send] [get_bd_pins IR_transmission_8/send] [get_bd_pins IR_transmission_9/send] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_pins IR_transmission_1/addr] [get_bd_pins axi_gpio_2/gpio2_io_o]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins IR_transmission_1/code] [get_bd_pins axi_gpio_2/gpio_io_o]
  connect_bd_net -net axi_gpio_3_gpio2_io_o [get_bd_pins IR_transmission_2/addr] [get_bd_pins axi_gpio_3/gpio2_io_o]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_pins IR_transmission_2/code] [get_bd_pins axi_gpio_3/gpio_io_o]
  connect_bd_net -net axi_gpio_4_gpio2_io_o [get_bd_pins IR_transmission_3/addr] [get_bd_pins axi_gpio_4/gpio2_io_o]
  connect_bd_net -net axi_gpio_4_gpio_io_o [get_bd_pins IR_transmission_3/code] [get_bd_pins axi_gpio_4/gpio_io_o]
  connect_bd_net -net axi_gpio_5_gpio2_io_o [get_bd_pins IR_transmission_4/code] [get_bd_pins axi_gpio_5/gpio2_io_o]
  connect_bd_net -net axi_gpio_5_gpio_io_o [get_bd_pins IR_transmission_4/addr] [get_bd_pins axi_gpio_5/gpio_io_o]
  connect_bd_net -net axi_gpio_6_gpio2_io_o [get_bd_pins IR_transmission_5/code] [get_bd_pins axi_gpio_6/gpio2_io_o]
  connect_bd_net -net axi_gpio_6_gpio_io_o [get_bd_pins IR_transmission_5/addr] [get_bd_pins axi_gpio_6/gpio_io_o]
  connect_bd_net -net axi_gpio_7_gpio2_io_o [get_bd_pins IR_transmission_6/code] [get_bd_pins axi_gpio_7/gpio2_io_o]
  connect_bd_net -net axi_gpio_7_gpio_io_o [get_bd_pins IR_transmission_6/addr] [get_bd_pins axi_gpio_7/gpio_io_o]
  connect_bd_net -net axi_gpio_8_gpio2_io_o [get_bd_pins IR_transmission_7/code] [get_bd_pins axi_gpio_8/gpio2_io_o]
  connect_bd_net -net axi_gpio_8_gpio_io_o [get_bd_pins IR_transmission_7/addr] [get_bd_pins axi_gpio_8/gpio_io_o]
  connect_bd_net -net axi_gpio_9_gpio2_io_o [get_bd_pins IR_transmission_8/code] [get_bd_pins axi_gpio_9/gpio2_io_o]
  connect_bd_net -net axi_gpio_9_gpio_io_o [get_bd_pins IR_transmission_8/addr] [get_bd_pins axi_gpio_9/gpio_io_o]
  connect_bd_net -net clk_ask_1_1 [get_bd_ports clk_ask_1] [get_bd_pins transmitt_parallel_0/clk_ask]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins IR_transmission_0/clk] [get_bd_pins IR_transmission_1/clk] [get_bd_pins IR_transmission_2/clk] [get_bd_pins IR_transmission_3/clk] [get_bd_pins IR_transmission_4/clk] [get_bd_pins IR_transmission_5/clk] [get_bd_pins IR_transmission_6/clk] [get_bd_pins IR_transmission_7/clk] [get_bd_pins IR_transmission_8/clk] [get_bd_pins IR_transmission_9/clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_10/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_gpio_5/s_axi_aclk] [get_bd_pins axi_gpio_6/s_axi_aclk] [get_bd_pins axi_gpio_7/s_axi_aclk] [get_bd_pins axi_gpio_8/s_axi_aclk] [get_bd_pins axi_gpio_9/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/M09_ACLK] [get_bd_pins axi_interconnect_0/M10_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_125M/slowest_sync_clk]
