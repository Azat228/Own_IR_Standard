...
-- Date        : Tue Aug 19 18:54:38 2025
-- Host        : Azat running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/azati/Own_IR_transmitter/Own_IR_transmitter.gen/sources_1/bd/design_1/ip/design_1_IR_transmission_2_4/design_1_IR_transmission_2_4_sim_netlist.vhdl
-- Design      : design_1_IR_transmission_2_4
...
entity design_1_IR_transmission_2_4_IR_transmission is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_IR_transmission_2_4_IR_transmission : entity is "IR_transmission";
end design_1_IR_transmission_2_4_IR_transmission;

architecture STRUCTURE of design_1_IR_transmission_2_4_IR_transmission is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[2]_i_11\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FSM_sequential_state[2]_i_13\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_sequential_state[2]_i_14\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[2]_i_9\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of pulse_active_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \shift_reg[7]_i_10\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \shift_reg[7]_i_11\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \shift_reg[7]_i_5\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \shift_reg[7]_i_7\ : label is "soft_lutpair3";
begin
  ir_out <= \^ir_out\;
\FSM_sequential_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0A0A5E5E555A5A5A"
    )
        port map (
      I0 => state(0),
...
\counter[30]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A280"
    )
        port map (
...
pulse_active_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EAAA"
    )
        port map (
...
\shift_reg[7]_i_10\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\shift_reg[7]_i_11\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\shift_reg[7]_i_12\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\shift_reg[7]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_IR_transmission_2_4 is
  port (
    clk : in STD_LOGIC;
    code : in STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_IR_transmission_2_4 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_IR_transmission_2_4 : entity is "design_1_IR_transmission_2_4,IR_transmission,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_IR_transmission_2_4 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_IR_transmission_2_4 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_IR_transmission_2_4 : entity is "IR_transmission,Vivado 2020.2.2";
end design_1_IR_transmission_2_4;

architecture STRUCTURE of design_1_IR_transmission_2_4 is
...
begin
inst: entity work.design_1_IR_transmission_2_4_IR_transmission
     port map (
